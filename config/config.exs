...
config :esbuild,
  ...
  clinic_demo: [
    ...
    args:
      ~w(js/app.js js/operator_diagram.js js/flight_view.js --bundle --target=es2022 --outdir=../priv/static/assets/js --external:/fonts/* --external:/images/* --external:/assets/* --alias:@=.) ++
