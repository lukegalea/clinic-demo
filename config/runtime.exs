...
#
#     PHX_SERVER=true bin/clinic_demo start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :clinic_demo, ClinicDemoWeb.Endpoint, server: true
end
  ...
  config :clinic_demo, ClinicDemoWeb.Endpoint,
    live_reload: [
      ...
      patterns: [
        ...
        ~r"lib/clinic_demo_web/router\.ex$"E,
        ~r"lib/clinic_demo_web/(controllers|live|components)/.*\.(ex|heex)$"E
      ]
    ]
end
...
if config_env() == :prod do
  ...
  config :clinic_demo, ClinicDemo.Repo,
    # ssl: true,
    url: database_url,
